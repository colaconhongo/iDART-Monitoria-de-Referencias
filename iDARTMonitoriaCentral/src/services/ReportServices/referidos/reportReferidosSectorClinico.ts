...
const title = 'Lista de Pacientes Referidos para Sector Clinico';
const reportName = 'PacientesReferidosSectorClinico';
...
export default {
  async downloadPDF(
    ...
    */
    ...
    const rows = await reportService.getReferedPatientsClinicSectorReport(
      params
    );
  ...
  async downloadExcel(
    ...
    worksheet.addTable({
      ...
      columns: [
        ...
        {
          name: 'Data da Última Prescrição',
