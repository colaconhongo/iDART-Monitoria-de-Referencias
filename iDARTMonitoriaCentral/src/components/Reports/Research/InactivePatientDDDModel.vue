...
import reportInactivePatients from 'src/services/ReportServices/inactivePatientsDDDModel/reportInactivePatientsDDDModel';
...
const generateReport = (params) => {
  if (params.value.fileType === 'PDF') {
    reportInactivePatients.downloadPDF(
      null,
    ...
    reportInactivePatients.downloadExcel(
      null,
      params.value.province.name,
      useUtils.getDateFormatDDMMYYYYDash(params.value.startDate),
      useUtils.getDateFormatDDMMYYYYDash(params.value.endDate),
