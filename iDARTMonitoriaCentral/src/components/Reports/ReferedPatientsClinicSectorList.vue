...
import reportReferidos from 'src/services/ReportServices/referidos/reportReferidosSectorClinico';
import useUtils from 'src/use/useUtils';

const title = ref('Lista de Pacientes Referidos para Sectores Clinicos');
