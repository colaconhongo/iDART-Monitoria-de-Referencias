...
const stockDetails = computed(() => {
  const list = stockReportService.getAllDetailsOfDrugFromStorage(
    selectRecord.value.drugid,
    selectRecord.value.clinicuuid
  );
